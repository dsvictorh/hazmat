...
{
    public class CreateEditModuleFreeTextFormModel : BaseFormModel<CreateEditModuleFreeTextFormModel>
    {
        ...
        private ModuleFreeText _module;
        ...
        protected override bool OnValidate()
        {
            ...
            if (Id != 0)
            {
                _module = ModuleFreeText.Query.SingleOrDefault(mc => mc.Id == Id);
                if (_module == null)
                {
                ...
                var moduleTypeId = ModuleService.ModuleTypes[ModuleService.MODULE_FREE_TEXT];
        ...
        protected override void OnSubmit()
        {
            ...
            if (isNew)
            {
                _module = new ModuleFreeText();
                _pageModule = new PageModule();
                _pageModule.ModuleTypeId = ModuleService.ModuleTypes[ModuleService.MODULE_FREE_TEXT];
            ...
            using (var conn = new NTGDBTransactional())
            {
                ...
                NTGLogger.LogSiteAction(HttpContext.Current.Request,
                        ...
                        _page.Name,
                        _module.Id,
                        ModuleService.MODULE_FREE_TEXT,
                        conn);
        ...
        {
            return "FreeText" + (Id != 0 ? Id.ToString() : string.Empty);
        }
    }
}